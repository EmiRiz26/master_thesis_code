...
def save_sample_predictions(original_texts, sample_indices, y_true, predictions, model_names):
    ...
    sample_df.to_csv('model_sample_predictions_Rotten_tomatoes_Twitter.csv', index=False)
...
def main():
    ...
    # General Movie Terms
    "movie", "movies", "film", "films", "cinema", "screen",
    "plot", "story", "script", "screenplay", "scene", "scenes",
    "character", "characters", "role", "roles",
    "director", "directing", "direction",
    "actor", "actors", "actress", "actresses", "cast",
    "performance", "performances",
    "dialogue", "dialogues",

    # Production and Technical Aspects
    "production", "producer", "studio",
    "editing", "editor",
    "set", "setting",
    "effect", "effects", "specialeffects", "cgi",
    "sound", "soundtrack", "music", "score",
    "cinematography", "lighting",
    "camera", "angle",

    # Reception and Critique Terms
    "review", "reviews",
    "rating", "ratings",
    "critique", "critic", "critics",
    "award", "awards", "nomination", "nominations",
    "festival", "screening",

    # Genre and Theme Descriptors
    "comedy", "drama", "thriller", "horror", "romance",
    "action", "adventure", "sci-fi", "sciencefiction", "fantasy",
    "documentary", "animation", "biography", "crime",
    "classic", "blockbuster",

    # Distribution Terms
    "release", "released", "premiere", "premiered",
    "boxoffice", "gross", "budget",
    
    # Miscellaneous
    "trailer", "teaser",
]
    df_tomatoes = pd.read_csv('./Rotten_tomatoes.csv')

    # df_tomatoes['review_cleaned'] = df_tomatoes['text'].apply(clean_text)
    df_tomatoes['review_cleaned'] = df_tomatoes['text'].apply(lambda x: clean_text(x, domain_specific_words_IMDB))
    df_tomatoes['polarity_score'] = df_tomatoes['review_cleaned'].apply(lexicon_sentiment_analysis)
    ...
    X_train = df_tomatoes['review_cleaned']
    y_train = df_tomatoes['label']

    # Polarized sentiment as regression target
    y_train_polarity = df_tomatoes['polarity_score']
