...
def save_sample_predictions(original_texts, sample_indices, y_true, predictions, model_names):
    ...
    sample_df.to_csv('model_sample_predictions_Rotten_tomatoes_Spotify.csv', index=False)
...
def main():
    ...
    X_test = df_Spotify['review_cleaned']
    y_test = df_Spotify['sentiment_label']
    ...
    y_test_polarity = df_Spotify['polarity_score']
