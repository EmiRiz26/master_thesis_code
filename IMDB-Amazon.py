...
def save_sample_predictions(original_texts, sample_indices, y_true, predictions, model_names):
    ...
    sample_df.to_csv('model_sample_predictions_IMDB_Amazon.csv', index=False)
...
def main():
    ...
    df_IMDB['review_cleaned'] = df_IMDB['review'].apply(lambda x: clean_text(x, domain_specific_words_IMDB))
