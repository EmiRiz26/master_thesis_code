...
def save_sample_predictions(original_texts, sample_indices, y_true, predictions, model_names):
    ...
    sample_df.to_csv('model_sample_predictions_IMDB_Twitter.csv', index=False)
...
def main():
    ...
    # Common Review Phrases specific to film context
    #"masterpiece", "overrated", "underrated", "classic", "disappointing", "lackluster",
    
    # Emotions and Reactions relevant to films
    #"funny", "scary", "thrilling", "boring", "touching", "emotional", "engaging", "entertaining",
    ...
    X_train = df_IMDB['review_cleaned']
    y_train = df_IMDB['sentiment_label']

    # Polarized sentiment as regression target
    y_train_polarity = df_IMDB['polarity_score']
