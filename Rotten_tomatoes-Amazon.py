...
def save_sample_predictions(original_texts, sample_indices, y_true, predictions, model_names):
    ...
    sample_df.to_csv('model_sample_predictions_Rotten_tomatoes_Amazon.csv', index=False)
...
def main():
    ...
    X_test = df_Amazon['review_cleaned']
    y_test = df_Amazon[0]
    ...
    y_test_polarity = df_Amazon['polarity_score']
